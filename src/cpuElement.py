...
class CPUElement:
    ...
    def connect(self, input, outputValueNames, control, outputSignalNames):
        ...
        for i in self.inputSources:
            ...
            assert(name not in self.inputValues), 'Duplicate input value name: \'%s\' in CPU Element %s' % (name, repr(self))
        ...
        for i in self.controlSources:
            ...
            assert(name not in self.controlSignals), 'Duplicate input control signal name: \'%s\' in CPU Element %s' % (name, repr(self))
    ...
    def debug_print(self):
        # Prints all the elements input and output values and control signals
        print(f"{self.__class__.__name__}:\n input values: {self.inputValues}, output values: {self.outputValues}\n input signals: {self.controlSignals}, output signals: {self.outputControlSignals}\n")
